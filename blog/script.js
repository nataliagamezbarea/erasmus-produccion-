...
$.ajax({
    ...
    success: function (data) {
        // No es necesario filtrar las publicaciones por categoría
        ...
        if (data.length > 0) {
            ...
            // Iterar sobre cada publicación en los datos
            data.forEach(function (publicacion) {
                ...
                // Formatear la fecha actual para que coincida con el formato de la fecha de publicación
                var formattedFechaActual = fechaActual.toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric', hour: 'numeric', minute: 'numeric' });
                                ...
                                <div class="metafooter">
                                    <div class="wrapfooter">
                                        ...
                                        <span class="author-meta">
                                            ...
                                            <span class="post-date">${formattedFechaActual}</span>
                                        </span>
            ...
            // Manejar el caso en que no haya publicaciones disponibles
            $('#publicaciones-container').html('<p>No hay publicaciones disponibles.</p>');
        }
    },
