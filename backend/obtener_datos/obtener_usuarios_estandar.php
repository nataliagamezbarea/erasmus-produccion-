...
try {
    ...
    // Consulta SQL para contar los registros en la tabla de usuarios registrados con la categoría 'Usuario Estándar'
    $sql = "SELECT COUNT(*) as total FROM usuarios_registrados WHERE categoria = 'Usuario Estándar'";
    ...
    if ($result) {
        ...
        // Devolver solo el número total en formato JSON
        header('Content-Type: application/json');
        echo json_encode(['total_usuarios_estandar' => $total]);
    } else {
